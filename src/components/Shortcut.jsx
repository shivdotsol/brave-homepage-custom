    ...
    return (
        ...
        >
            <div className="h-[88px] w-[88px] flex flex-col items-center justify-between">
                <div className="w-16 h-16 flex items-center justify-center bg-[#4c4c4d] rounded-2xl border border-transparent group-hover:border-neutral-500  group-hover:shadow-[0px_5px_20px_0px] group-hover:shadow-neutral-400 transition-all duration-100">
